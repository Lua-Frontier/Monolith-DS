...
using Content.Shared._LuaM.TheCircle.Dreadnought;
...
namespace Content.Server._LuaM.TheCircle.Dreadnought;
...
public sealed class DreadnoughtLastStandSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        foreach (var (strap, pending) in _pendingStrapDestruction)
        {
            ...
            _stun.TryParalyze(pending.Wearer, pending.StunDuration, true);
        }
