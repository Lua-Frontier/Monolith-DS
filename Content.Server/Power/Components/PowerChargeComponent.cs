...
public sealed partial class PowerChargeComponent : SharedPowerChargeComponent
{
    ...
    /// <summary>
    /// MLua Power consumed when <see cref="SwitchedOn"/> is true and the power is fully charged.
    /// </summary>
    [DataField("activePower")]
    public float ActivePowerUse { get; set; }

    /// <summary>
    /// MLua Power consumed when <see cref="SwitchedOn"/> is true and the machine is not fully charged.
    /// </summary>
