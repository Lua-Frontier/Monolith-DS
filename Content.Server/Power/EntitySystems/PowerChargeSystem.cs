...
public sealed partial class PowerChargeSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<PowerChargeComponent, PowerChargeActionMessage>(OnActionAttempt); // MLua Frontier
    }
    ...
    public void SetSwitchedOn(EntityUid uid, PowerChargeComponent component, bool on,  // MLua Frontier: private<public for linking system in StationAnchorSystem.
    ...
    // MLua Frontier: Added action option
    ...
    {
        // MLua Start Frontier: update power state
        ...
        // End MLua Frontier: update power state
    }
        ...
        while (query.MoveNext(out var uid, out var chargingMachine, out var powerReceiver))
        {
            ...
            if (chargingMachine.SwitchedOn)
            {
                ...
                else
                {
                    ...
                    var ratio = 1 - mainSystemPower / (chargingMachine.ActiveChargingPowerUse - chargingMachine.IdlePowerUse); // MLua  Frontier: ActivePowerUse<ActiveChargingPowerUse
            ...
            // MLua Start Frontier: changing load when full
    ...
    private void UpdateUI(Entity<PowerChargeComponent, ApcPowerReceiverComponent> ent, float chargeRate)
    {
        ...
        var state = new PowerChargeState(
            ...
            component.Charge >= component.ActionCharge, // MLua  Frontier
...
[ByRefEvent] public record struct PowerChargeActionEvent; // MLua  Frontier
