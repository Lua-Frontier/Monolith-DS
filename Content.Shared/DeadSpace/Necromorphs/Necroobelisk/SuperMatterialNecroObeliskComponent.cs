...
public sealed partial class SuperMatterialNecroObeliskComponent : Component
{
    ...
    public string SoundDestruction = "/Audio/_LuaM/Necromorfs/unitolog_start.ogg";

    [DataField, ViewVariables(VVAccess.ReadOnly)]
    public string SoundConvergence = "/Audio/_LuaM/Necromorfs/marker_convergence.ogg";

    [DataField, ViewVariables(VVAccess.ReadOnly)]
    public string SoundInit = "/Audio/_LuaM/Necromorfs/marker_convergence.ogg";

    [DataField, ViewVariables(VVAccess.ReadOnly)]
    public string Sound = "/Audio/_LuaM/Necromorfs/marker_red.ogg";
