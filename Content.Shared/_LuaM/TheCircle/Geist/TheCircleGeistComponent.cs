...
public sealed partial class TheCircleGeistComponent : Component
{
    ...
    public List<GeistInvisibilityModeInfo> Modes = new()
    {
        new()
        {
            ...
            Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/_LuaM/Demons/ability_icons/shadowling_blink_action.png")),
            Tooltip = "geist-invisibility-mode-escape",
        },
        new()
        {
            Mode = GeistInvisibilityMode.Phase,
            Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/_LuaM/Demons/ability_icons/shadowling_ghost_action.png")),
            Tooltip = "geist-invisibility-mode-phase",
        },
        new()
        {
            Mode = GeistInvisibilityMode.Stationary,
            Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/_LuaM/Demons/ability_icons/shadowling_veil_action.png")),
