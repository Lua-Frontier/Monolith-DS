...
ent-EncryptionKeySecurity = ключ шифрования службы безопасности
    ...
    .suffix = НЕ МАППИТЬ
ent-EncryptionKeyService = ключ шифрования Колосса
    .desc = Ключ шифрования, используемый сотрудниками Центрального Аванпоста, которым поручено поддерживать станцию сытой, чистой и работоспособной.
    .suffix = НЕ МАППИТЬ
