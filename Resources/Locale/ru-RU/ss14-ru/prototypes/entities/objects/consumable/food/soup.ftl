...
ent-FoodPlainGrits = каша с маслом
    .desc = Сытная миска каши, покрытая кусочком масла.
ent-FoodCheeseGrits = сырная каша
    .desc = Тёплая и сытная миска каши с расплавленным сыром.