...
ent-ClothingOuterWinterHoP = зимняя куртка главы персонала
    .desc = { ent-ClothingOuterWinterCoat.desc }
ent-ClothingOuterWinterHoS = зимняя бронекуртка коменданта
    .desc = Прочная, утилитарная зимняя куртка, предназначенная для защиты коменданта от любых угроз, связанных с бригом и переохлаждением.
ent-ClothingOuterWinterHoSUnarmored = зимняя куртка коменданта
