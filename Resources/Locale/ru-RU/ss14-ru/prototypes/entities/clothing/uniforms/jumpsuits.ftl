...
ent-ClothingUniformJumpsuitHoS = комбинезон коменданта
    .desc = Он ярко-красный и хрустящий, какими часто бывают жертвы службы безопасности.
ent-ClothingUniformJumpsuitHoSAlt = водолазка коменданта
    .desc = Это водолазка, носимая теми, кто достаточно силён и дисциплинирован.
ent-ClothingUniformJumpsuitHoSBlue = синий комбинезон коменданта
    .desc = Синий комбинезон коменданта.
ent-ClothingUniformJumpsuitHoSGrey = серый комбинезон коменданта
    .desc = Серый комбинезон коменданта, который делает его несколько похожим на ассистента.
ent-ClothingUniformJumpsuitHoSParadeMale = парадная форма коменданта
...
ent-ClothingUniformJumpsuitCentcomFormal = торжественный костюм УСФ
    .desc = Костюм для особых случаев.
ent-ClothingUniformJumpsuitHosFormal = торжественный костюм коменданта
    .desc = Костюм для особых случаев.
...
ent-ClothingUniformJumpsuitERTChaplain = униформа священника 
    .desc = Специальный костюм, созданный для священников NT.
ent-ClothingUniformJumpsuitERTEngineer = униформа инженера 
    .desc = Специальный костюм, созданный для инженеров NT.
ent-ClothingUniformJumpsuitERTJanitor = униформа уборщика 
    .desc = Специальный костюм, созданный для уборщиков NT.
ent-ClothingUniformJumpsuitERTLeader = униформа лидера 
    .desc = Специальный костюм, созданный для командиров NT.
ent-ClothingUniformJumpsuitERTMedic = униформа медика 
    .desc = Специальный костюм, созданный для медиков NT.
ent-ClothingUniformJumpsuitERTSecurity = униформа офицера безопасности 
    .desc = Специальный костюм, созданный для офицеров безопасности NT.
