...
ent-ClothingUniformJumpskirtHoS = юбка-комбинезон коменданта
    .desc = Она ярко-красная и хрустящая, какими часто бывают жертвы службы безопасности.
ent-ClothingUniformJumpskirtHoSAlt = юбка-водолазка коменданта
    .desc = Это водолазка, носимая теми, кто достаточно силён и дисциплинирован. Её прочная ткань обеспечивает слабую защиту от механических повреждений.
ent-ClothingUniformJumpskirtHoSParadeMale = парадная форма коменданта
    .desc = Роскошная униформа коменданта, для особых случаев.
...
ent-ClothingUniformJumpskirtCentcomFormalDress = торжественное платье УСФ
    .desc = Платье для особых случаев.
ent-ClothingUniformJumpskirtHosFormal = торжественное платье коменданта
    .desc = Платье для особых случаев.
