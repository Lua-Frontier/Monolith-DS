...
ent-SheriffPDA = КПК полковника ТСФ
...
ent-DeputyPDA = КПК рядового ТСФ
...
ent-BrigmedicNFPDA = КПК фельдшера ТСФ
...
ent-SergeantPDA = КПК сержанта ТСФ
...
ent-BailiffPDA = КПК капитана ТСФ
...
ent-DetectiveNFPDA = КПК детектива ТСФ
...
ent-DocPDA = КПК врача
    .desc = Пахнет дезинфицирующим средством.
ent-NFDetectivePDA = КПК детектива ТСФ
    .desc = Этот сектор прогнил...
