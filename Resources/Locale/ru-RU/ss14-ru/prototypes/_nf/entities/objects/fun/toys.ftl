...
ent-ThronglerToy = Нагибатор
    ...
    .suffix = Игрушка
ent-WeaponLauncherRocketToy = RPG эмоциональной поддержки
    .desc = Деактивированный RPG, модифицированный для использования только с поролоновыми боеголовками. "Когда времена тяжелы и стресс зашкаливает, НЕ волнуйтесь, ведь у S.E.S.W.C есть то, что вам нужно!"
    .suffix = Игрушка
