...
ent-ClothingWalletLeatherMail = { ent-ClothingWalletLeatherBrown } 
    .desc = Внутри вышитая картинка кота, сердечко и слово "КЛИППИ". Внутри есть маленький пылесос для денег.
ent-ClothingWalletLeatherPirate = { ent-ClothingWalletLeatherBrown } 
    .desc = Внутри старая фотография кота с бородой. Внутри есть маленький пылесос для денег.
